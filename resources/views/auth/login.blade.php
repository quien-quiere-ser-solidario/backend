...
<div class="items-center justify-center w-screen h-screen flex bg-[url('https://images.unsplash.com/photo-1486520299386-6d106b22014b?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&q=80')] bg-no-repeat bg-center bg-cover">
  <form method="POST" action="{{ route('login') }}"  class="flex flex-col items-center justify-between gap-10 p bg-primary">
    @csrf
    <h1 class="text-3xl font-extrabold text-white">Admin Login</h1>
    <div class="flex flex-col">
      <label for="email" class="sr-only">Email</label>
      <input id="email" name="email" type="email" required placeholder="Email..." class="px-2 rounded-full" />
      <input id="password" name="password" type="password" required placeholder="Password..." class="px-2 rounded-full" />
    </div>
